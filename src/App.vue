<template>
  <v-app class="main">
    <v-main class="main">
      ...
      <AltConvert class="alt-converter" />
    </v-main>
  </v-app>
</template>

<script>
import AltConvert from "./components/AltConvert";
...
.main {
  ...
  background: -moz-linear-gradient(
    0deg,
    rgba(34, 67, 195, 1) 0%,
    rgba(63, 164, 245, 1) 24%,
    rgba(58, 149, 237, 1) 75%,
  ...
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#2243c3",endColorstr="#2243c3",GradientType=1);
}
...
.moveball {
  ...
  animation: moveX 5.05s linear 0s infinite alternate,
    moveY 5.4s linear 0s infinite alternate;
}
